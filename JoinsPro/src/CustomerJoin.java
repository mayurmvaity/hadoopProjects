	...
	public static class JRClass extends Reducer<Text,Text,Text,Text>
	{
		public void reduce(Text key, Iterable<Text> values, Context context)
		{
			try
			{
				...
				context.write(new Text(name), new Text(myvalue));
