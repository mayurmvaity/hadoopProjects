...
public class POSPgm extends Configured implements Tool {
	...
	public int run(String arg[]) throws Exception
	{
		...
		MultipleInputs.addInputPath(job, new Path(arg[0]), TextInputFormat.class, POSm1.class);
		MultipleInputs.addInputPath(job, new Path(arg[1]), TextInputFormat.class, POSm2.class);
	...
	{
		ToolRunner.run(new Configuration(), new POSPgm(), ar);
		System.exit(0);
	}
}
